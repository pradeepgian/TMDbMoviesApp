...
class PopularMoviesController: UICollectionViewController, UICollectionViewDelegateFlowLayout {
    ...
    private func popularMoviesViewModelObserver() {
        moviesViewModel.$fetchPopularMoviesState
    ...
    override func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return moviesViewModel.numberOfRowsForPopularMoviesIn(section: section)
    }
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let movieViewModel = moviesViewModel.getPopularMovieCellViewModel(for: indexPath) {
